...
// function main(argv) {
//   // cl argument processing
//   var args = {}, proxy, port;
//   argv.forEach(function(arg, idx) {
//     if (arg.indexOf('--') === 0) {
//       args[arg.substr(2)] = argv[idx+1];
//     }
//   });

//   port = Number(args.port) || DEFAULT_PORT;
//   SERVER_ROOT = args.root || DEFAULT_PATH;
...
//   var self = this;
//   var path = (SERVER_ROOT + req.url.pathname).replace('//','/').replace(/%(..)/g, function(match, hex){
